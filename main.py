...
parser.add_argument('--img', type=str, default='./input/images-optional/') 
parser.add_argument('--dr', type=str, default='./input/detection-results/')
parser.add_argument('--gt', type=str, default='./input/ground-truth/')
